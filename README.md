...
4. 다음 단계: synthetic event generator 구현
...
1. `src/event_generator.py`에서 session 기반 synthetic event 생성
2. `src/main.py`에서 생성된 이벤트 sample과 event type count 출력
3. PostgreSQL insert 로직 구현
4. SQL 집계 쿼리 작성
5. matplotlib 기반 PNG 시각화 생성
